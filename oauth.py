...
from models import db, Profile, User, Token, OAuth,Pregnancybyweeks,Symtoms,Nutrition,Excercises,Losses, Plainning, Lifestyles,Laboranddelivery
...
def facebook_logged_in(blueprint, token):
    ...
    try:
        ...
        db.session.commit()
    return redirect("http://localhost:3000/user/update/?api_key={}".format(token.uuid))
